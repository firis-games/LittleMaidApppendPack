...
public class ModelLittleMaid_ChibiNeko extends ModelLittleMaid_Archetype {
	...
	public void setLivingAnimations(IModelCaps var1, float var2, float var3, float var4) {
		...
		// System.out.println(String.format(" living :
		// %s",var1.getClass().getSimpleName()));
		...
		if (0.0F > mh_sin(f3 * 0.17F) + mh_sin(f3 * 0.17F + 0.02F) + mh_sin(f3 * 0.11F) + mh_sin(f3 * 0.7F) + 3.10F) {
			EarL1.rotateAngleZ = EarR1.rotateAngleZ = EarLi1.rotateAngleZ = EarRi1.rotateAngleZ = -30F / 180F
					* (float) Math.PI;
			EarL2.rotateAngleZ = EarR2.rotateAngleZ = EarLi2.rotateAngleZ = EarRi2.rotateAngleZ = 30F / 180F
					* (float) Math.PI;
			...
			EarL1.rotateAngleZ = EarR1.rotateAngleZ = EarLi1.rotateAngleZ = EarRi1.rotateAngleZ = -40F / 180F
					* (float) Math.PI;
			EarL2.rotateAngleZ = EarR2.rotateAngleZ = EarLi2.rotateAngleZ = EarRi2.rotateAngleZ = 40F / 180F
					* (float) Math.PI;
	...
	public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6,
		...
		// System.out.println(String.format(" rotation :
		// %s",var7.getClass().getSimpleName()));
		...
		if (bipedHead.rotateAngleX > convertDegtoRad(10F))
			Tail2.rotateAngleX = Tail3.rotateAngleX = Tail4.rotateAngleX = Tail5.rotateAngleX = Tail6.rotateAngleX = -convertDegtoRad(
					10F);
		else
