...
public class ModelLittleMaid_DogAngel extends MMM_ModelLittleMaid_Archetype {
	...
	//	Ahoge.setRotationPointLM(0F, -8F, -4F);
		...
		Skirt1 = new MMM_ModelRenderer(this, -1, 16);
...
public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, MMM_IModelCaps var7)
{
	super.setRotationAngles(var1,  var2,  var3,  var4,  var5,  var6, var7);
		...
		WingLOrigin.rotateAngleY=MathHelper.cos(t * 0.5F) * 0.2F - 0.3F;// MathHelper.cos(f2 * 0.6662F) * 10.0F * f1 * 0.5F;
		WingROrigin.rotateAngleY=MathHelper.cos(t * 0.5F + (float)Math.PI) * 0.2F + 0.3F;// MathHelper.cos(f2 * 0.6662F + (float)Math.PI) * 4.0F * f1 * 0.5F;
