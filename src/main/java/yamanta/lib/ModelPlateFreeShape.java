...
public class ModelPlateFreeShape extends ModelBox {
	 ...
	 *            : PositionOffsetZ
	 * @param k
	 *            : length or depthX(depthZ, depthX)
	 * @param l
	 *            : angle, in Degree, or depthY(depthY, depthZ)
	 * @param i1
	 *            : Select Plane and Triangle Shape; Sum Plane No. and Shape No.
	 *            <ul>
	 *            Plane No.<br>
	 *            <ul>
	 *            0 : XY Plane<br>
	 ...
	 *            : scale
	 */
	public ModelPlateFreeShape(ModelRenderer modelrenderer, float vertex[][], float texUV[][], float vertexN[][],
			float RGBA[], float scale) {
