...
public class ModelLittleMaid_Yomu extends ModelLittleMaidBase_YamantaArchetype {
	...
	public ModelRendererEX Headband1;
	public ModelRendererEX Headband2;
	public ModelRendererEX Headband3;
	public ModelRendererEX Headband4;
	...
	public ModelRendererEX Collar1;
	public ModelRendererEX Collar2;
	public ModelRendererEX Collar3;
	public ModelRendererEX Collar4;
	public ModelRendererEX Collar5;
	public ModelRendererEX Collar6;
	public ModelRendererEX Collar7;
	public ModelRenderer Best1;
	public ModelRenderer Best2;
	public ModelRendererEX Patch;
	public ModelRendererEX Hear;
	...
	public ModelRendererEX HanreiC;
	// public ModelRenderer_EX Hanrei1;
	// public ModelRenderer_EX Hanrei2;
	// public ModelRenderer_EX Hanrei3;
	public ModelRendererEX Hanrei4;
	public ModelRendererEX Hanrei5;
	// public ModelRenderer_EX Hanrei6;

	// armor only
	public ModelRendererEX PlateR1;
	public ModelRendererEX PlateR2;
	public ModelRendererEX PlateR3;
	public ModelRendererEX PlateR4;
	public ModelRendererEX PlateR5;
	public ModelRendererEX PlateR6;
	public ModelRendererEX PlateL1;
	public ModelRendererEX PlateL2;
	public ModelRendererEX PlateL3;
	public ModelRendererEX PlateL4;
	public ModelRendererEX PlateL5;
	public ModelRendererEX PlateL6;
...
//		childPositionList = new ArrayList();
		...
		Skirt1 = new ModelRendererEX(this, 0, 33, 0.5F, 0.5F, 1F);
		...
		Collar1 = new ModelRendererEX(this, 0, 16, 0.7F, 0.7F, 0.7F);
		...
		Collar2 = new ModelRendererEX(this, 0, 16, 0.6F, 0.6F, 0.6F);
		...
		Collar3 = new ModelRendererEX(this, 0, 16, 0.7F, 0.7F, 0.7F);
		...
		Collar4 = new ModelRendererEX(this, 0, 16, 0.6F, 0.6F, 0.6F);
		...
		Collar5 = new ModelRendererEX(this, 0, 16, 0.9F, 0.9F, 0.9F);
		...
		Collar6 = new ModelRendererEX(this, 0, 16, 0.9F, 0.9F, 0.9F);
		...
		Collar7 = new ModelRendererEX(this, 48, 2, 0.8F, 0.8F, 0.8F);
		...
		Patch = new ModelRendererEX(this, 0, 39, 0.1F, 0.1F, 0.1F);
		...
		Headband1 = new ModelRendererEX(this, 0, 20, 1.0F, 0.3F, 1.0F);
		...
		Headband2 = new ModelRendererEX(this, 0, 20, 1.0F, 0.3F, 1.0F);
		...
		Headband3 = new ModelRendererEX(this, 0, 20, 1.0F, 0.3F, 1.0F);
		...
		Headband4 = new ModelRendererEX(this, 0, 20, 1.0F, 0.3F, 1.0F);
		...
		Ribon4 = new ModelRendererEX(this, 0, 22, 0.5F, 0.5F, 0.5F);
		...
		Ribon5 = new ModelRendererEX(this, 0, 22, 0.8F, 0.8F, 0.8F);
		...
		Ribon6 = new ModelRendererEX(this, 0, 22, 0.8F, 0.8F, 0.8F);
		...
		Hear = new ModelRendererEX(this, 20, 32, 1.1F, 1.1F, 1.1F);
		...
		HanreiC = new ModelRendererEX(this, 0, 0);
...
//		IdOffset = 0F;
		...
		/*
		 * Hanrei1 = new ModelRenderer_EX(this,0 ,0); // Hanrei1.addBox(-1F, -1F,-2F, 2,
		 * 2, 4, psize); Hanrei1.addBall(0f,0f,0f,6f,6f,6f);
		 * Hanrei1.setRotationPointLM(0F,0.0F,0F); setRotationDeg(Hanrei1,0F,0F,0F); //
		 * bipedBody.addChild(Hanrei1);
		 * 
		 * Hanrei2 = new ModelRenderer_EX(this,2 ,24); Hanrei2.addBox(-1F, -1F,-2F, 2,
		 * 2, 4, psize); Hanrei2.setRotationPointLM(8F,0.0F,4F);
		 * setRotationDeg(Hanrei2,90F,0F,0F);
		 * 
		 * Hanrei3 = new ModelRenderer_EX(this,2 ,24); Hanrei3.addBox(-1F, -1F,-2F, 2,
		 * 2, 4, psize); Hanrei3.setRotationPointLM(8F,0.0F,4F);
		 * setRotationDeg(Hanrei3,0F,90F,0F);
		 */
		Hanrei4 = new ModelRendererEX(this, 0, 0);
		...
		Hanrei5 = new ModelRendererEX(this, 0, 0);
...
//	}
	 ...
	 * distX, float distY, float distZ){ float position[]; float childPosition[];
	 * int idIndex; try{ idIndex=IdList.indexOf(entityliving.entityId);
	 * position=(float[])positionList.get(idIndex);
	 * childPosition=(float[])childPositionList.get(idIndex); }catch(Exception e){
	 * position=new float[3]; //
	 * position[0]=(float)Math.cos(-entityliving.renderYawOffset*(float)Math.PI/180f
	 * )*(float)entityliving.posX //
	 * +(float)(-Math.sin(-entityliving.renderYawOffset*(float)Math.PI/180f))*(float
	 * )entityliving.posZ; ///
	 * position[2]=(float)Math.sin(-entityliving.renderYawOffset*(float)Math.PI/180f
	 * )*(float)entityliving.posX //
	 * +(float)(Math.cos(-entityliving.renderYawOffset*(float)Math.PI/180f))*(float)
	 * entityliving.posZ; position[0]=(float)entityliving.posX;
	 * position[1]=(float)entityliving.posY; position[2]=(float)entityliving.posZ;
	 * IdList.add(entityliving.entityId);
	 * idIndex=IdList.indexOf(entityliving.entityId); positionList.add(position);
	 * childPosition=new float[3]; // childPosition[0]=(float)model.rotationPointX;
	 ...
	 * childPosition[2]=(float)entityliving.posZ; childPosition[0]=0f;
	 * childPosition[1]=0f; childPosition[2]=0f;
	 * childPositionList.add(childPosition); } float trans[]=new float[2];
	 * trans[0]=(float)Math.cos(-entityliving.renderYawOffset*(float)Math.PI/180f)*(
	 * float)entityliving.posX
	 * +(float)(-Math.sin(-entityliving.renderYawOffset*(float)Math.PI/180f))*(float
	 * )entityliving.posZ;
	 * trans[1]=(float)Math.sin(-entityliving.renderYawOffset*(float)Math.PI/180f)*(
	 * float)entityliving.posX
	 * +(float)(Math.cos(-entityliving.renderYawOffset*(float)Math.PI/180f))*(float)
	 * entityliving.posZ;
	 * 
	 * // float move[]={trans[0]-position[0], //
	 * (float)entityliving.posY-position[1], // trans[1]-position[2]}; float
	 * move[]={(float)entityliving.posX-position[0],
	 * (float)entityliving.posY-position[1], (float)entityliving.posZ-position[2]};
	 * move[0]=childPosition[0]-move[0]; move[1]=childPosition[1]-move[1];
	 * move[2]=childPosition[2]-move[2]; // float trans[]=new float[2];
	 * trans[0]=move[0]*(float)Math.cos(entityliving.renderYawOffset*(float)Math.PI/
	 * 180f)+move[2]*(float)(-Math.sin(entityliving.renderYawOffset*(float)Math.PI/
	 * 180f));
	 * trans[1]=move[0]*(float)Math.sin(entityliving.renderYawOffset*(float)Math.PI/
	 * 180f)+move[2]*(float)Math.cos(entityliving.renderYawOffset*(float)Math.PI/
	 * 180f); // model.rotationPointX=childPosition[0]-(trans[0]+distX); //
	 ...
	 * model.rotationPointZ=(trans[1]+distZ); model.rotationPointX=trans[0];
	 * model.rotationPointY=move[1]; model.rotationPointZ=trans[1];
	 * model.rotationPointX*=0.99f; model.rotationPointY*=0.99f;
	 * model.rotationPointZ*=0.99f; model.rotationPointX+=distX;
	 * model.rotationPointY+=distY; model.rotationPointZ+=distZ; //
	 * model.rotationPointX=distX*(float)Math.cos(entityliving.renderYawOffset*(
	 * float)Math.PI/180f)+distZ*(float)(-Math.sin(entityliving.renderYawOffset*(
	 * float)Math.PI/180f)); // model.rotationPointY=0f; //
	 * model.rotationPointZ=distX*(float)Math.sin(entityliving.renderYawOffset*(
	 * float)Math.PI/180f)+distZ*(float)(Math.cos(entityliving.renderYawOffset*(
	 * float)Math.PI/180f)); // model.rotateAngleY=entityliving.renderYawOffset; //
	 ...
	 * entityliving.posZ; position[0]=(float)entityliving.posX;
	 * position[1]=(float)entityliving.posY; position[2]=(float)entityliving.posZ;
	 * childPosition[0]=model.rotationPointX; childPosition[1]=model.rotationPointY;
	 * childPosition[2]=model.rotationPointZ;
	 * childPosition[0]=(model.rotationPointX-distX)*(float)Math.cos(-entityliving.
	 * renderYawOffset*(float)Math.PI/180f)+(model.rotationPointZ-distZ)*(float)(-
	 * Math.sin(-entityliving.renderYawOffset*(float)Math.PI/180f));
	 * childPosition[2]=(model.rotationPointX-distX)*(float)Math.sin(-entityliving.
	 * renderYawOffset*(float)Math.PI/180f)+(model.rotationPointZ-distZ)*(float)(
	 * Math.cos(-entityliving.renderYawOffset*(float)Math.PI/180f));
	 * System.out.println(String.format("mx : %.2f, my : %.2f, mz : %.2f",move[0],
	 * move[1],move[2]));
	 * System.out.println(String.format("x : %.2f, y : %.2f, z : %.2f",model.
	 * rotationPointX,model.rotationPointY,model.rotationPointZ));
