 ...
 * 身長2.0ブロック級
 */
public class MMM_ModelLittleMaid_Chloe2 extends MMM_ModelLittleMaidBase {
	 ...
	 * コンストラクタは全て継承させること
	 */
	public MMM_ModelLittleMaid_Chloe2() {
		this(0F);
	}
	/**
	 * コンストラクタは全て継承させること
	 */
	public MMM_ModelLittleMaid_Chloe2(float psize) {
		this(psize, 0F, 128, 64);
	}
	/**
	 * コンストラクタは全て継承させること
	 */
	public MMM_ModelLittleMaid_Chloe2(float psize, float pyoffset, int pTextureWidth, int pTextureHeight) {
